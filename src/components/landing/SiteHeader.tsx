...
export const SiteHeader = () => {
  ...
  return (
    <header className="sticky top-0 z-[60] flex items-center gap-[clamp(16px,2.4vw,34px)] border-b border-brand/10 bg-white/[.86] px-section-x py-[14px] backdrop-blur-[14px]">
      ...
      >
        ...
        {/*
          Below the nav breakpoint the bar has no room for the language switch or
          the log-in link, so they live here instead of being dropped entirely.
        */}
